        ...
        <div class="enter-api-key">
            <form action="<?php echo esc_url( Hatedetect_Admin::get_page_url() ); ?>" method="post">
                ...
                <p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
                    <input id="key" name="key" type="text" size="15" value="" placeholder="<?php esc_attr_e( 'Enter your API key' , 'hatedetect' ); ?>" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;">
                    <input type="submit" name="submit" id="submit" class="hatedetect-button" value="<?php esc_attr_e( 'Connect with API key', 'hatedetect' );?>">
                </p>
                <br>
                <p>
