                                ...
                                <p>
                                    <label for="hatedetect_auto_allow"
                                        ...
                                        <input
                                            ...
                                            checked(true, (in_array(get_option('hatedetect_auto_allow'), array(false, '1', 'true'), true)));
                            ...
                            <td align="left">
                                <fieldset>
                                    <legend class="screen-reader-text">
                                        <span><?php esc_html_e('HateDetect privacy notice', 'hatedetect'); ?></span></legend>
                                    ...
                                    <p><label for="hatedetect_comment_form_privacy_notice_hide"><input type="radio"
                                                                                                    ...
                                                                                                    value="hide" <?php echo in_array(get_option('hatedetect_comment_form_privacy_notice'), array('display', 'hide')) ? checked('hide', get_option('hatedetect_comment_form_privacy_notice'), false) : 'checked="checked"'; ?> /> <?php esc_html_e('Do not display privacy notice.', 'hatedetect'); ?>
                                        </label></p>
                                </fieldset>
